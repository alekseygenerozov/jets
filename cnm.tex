...
\caption{\label{fig:diss} Fraction of the slow component ($\Gamma=2$)
  kinetic energy dissipated by the reverse shock vs. the jet energy
  ($E_{\rm j}$) and $n_{18}$. It is implicitly assumed that the jet is
  isotropic so that $E_{\rm j}\approx E_{\rm j, iso}$, and that the
  jet has constant luminosity for $5\times 10^5$ seconds.}
\end{figure}
