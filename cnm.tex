...
a simple steady-state, spherical symmetric, hydrodynamic model
...
maximum density of $n_{18} \sim 2,700$ cm$^{-3}$ is achieved for a
...
orders of magnitude across the ring--see \citealt{Ferriere2012} and
