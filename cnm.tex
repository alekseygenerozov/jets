...
\section{Jet Models}
\label{sec:numerical}
We calculate radio light curves across the physically plausible
range of nuclear gas densities.  The jet-CNM interaction simulated in
one and two-dimensions, and the resulting synchrotron emission is
computed using the procedure described in \citet{Mimica+2015}.
For the jet model we take the preferred two-component model for SwJ1644
from \citet{Mimica+2015}: a fast, $\Gamma=10$ inner core and a slow,
