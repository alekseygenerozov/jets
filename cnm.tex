...
5 GHz for TDE candidates. The top panel shows the light curves for
a fixed density normalization. Changing the density
...
minimum and maximum plausible $n_{18}$: 0.5 cm$^{-3}$ and 2000 cm$^{-3}$
...
jet energies along with radio upper limits. The minimum synchrotron
luminosity curve going through each upper limit, corresponds to the
maximum possible jet energy for that limit.
