...
\caption{\label{fig:profiles} Steady-state gas density profiles for
  ...
  $10^{18}$ cm ($n_{18}$). For each radius, we indicate the value of
  isotropic equivalent jet energy $E_{52} n_{18}^{1}$, of a $\gamma$=2
  jet that sweeps up its own mass at that radius.}
\end{figure}
