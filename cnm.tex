...
\citealt{McConnell+2011})\footnote{This may be of questionable
  validity for low mass black holes (e.g., \citealt{Greene+2010,
    Kormendy+2013}). Also, several of the black hole masses used in
  \citet{McConnellMa+:2011a} were underestimated
  \citep{Kormendy+2013}. However, the precise form of the
...
characteristic value of $n_{18}\sim (10-100)$ cm$^{-3}$ in the host galaxies of most observed TDEs.
