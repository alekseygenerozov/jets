...
clumpy medium (Obergaulinger, M.; Chimeno, J. M.; Mimica, P.;
Aloy, M. A.; Iyudin, A., High Energy Density Physics, 17, 92-97,
2015). We note that even the presence of a star directly in the path
of the faster core of a two-component jet would probably not result in
...
shown in the right panels of Fig.~\ref{fig:lightcurves}, where the
stand alone contribution of the slower jet sheath is shown in lighter
shades for each of the values of $n_{18}$ at hand. Coincidentally, the
fast component just compensates for this decline, resulting in the
total (fast + slow) peak luminosity being weakly dependent on n18
...
dendity model ($n_{18}=2$ cm$^{-3}$ and $E_j=5\times 10^{53}$
