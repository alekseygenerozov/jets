...
across this grid, as well as contours of the peak luminosity of just
the slow sheath. In general, the slow component is more important for
higher densities and lower frequencies.  This is further illustrated
...
\begin{figure*}
  ...
  \caption{\label{fig:jetContours} {\it {Left:}} Thick solid lines
    ...
    component of the jet (see~\ref{sec:2D}). {\it Right:} Analytic
...
(generalizing \citealt{Nakar&Piran2011} who derive scalings for a
...
% greater than $\nu_m$. 
The peak of the light curve will occur at the
