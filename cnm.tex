...
5 GHz for TDE candidates. In the top panel shows the light curves for
a fixed density normalization. Note that changing the density
normalization simply shifts the light curve in time. Thus, the radio
luminosity at any given time is bounded by the luminosities for the
minimum and maximum plausible $n_{18}$: 1 cm$^{-3}$ and 2000 cm$^{-3}$
respectively. The bottom panel of Fig.~\ref{fig:econtours} shows the
curves of the minimum possible synchrotron luminosity for different
jet energies along with radio upper limits. The maximum jet energy for
each radio upper limit has a minimum synchrotron luminosity curve
