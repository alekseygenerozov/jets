...
formed a Hubble time ago (solid gray line).  Towards the top right the
...
\caption{\label{fig:1d2dB} Comparison of 1-d and 2-d light-curves for
  ...
  \citet{Mimica+2015} and 1-d results suggest that the density slope would
...
the 2-d light-curve falls $\sim$one order of magnitude below the 1-d
light-curve after $\sim$ 10 years. Thus, we caution that the 1-d
...
\begin{figure} 
  ...
  \caption{\label{fig:upper_limits} Off-axis ($\theta_{\rm obs}=0.8$)
    ...
    model had already been computed and since the 1-d results suggest
