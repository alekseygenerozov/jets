...
\caption{\label{fig:diss} Fraction of the slow component
  ...
  vs. the isotropic jet luminosity ($L_{\rm j,iso}$) and $n_{18}$.  {\bf BDM: may y axis an energy axis and mark Case 1 and Case 2}}
\end{figure}
...
The left-hand side of Fig.~\ref{fig:jetContours} shows contours of the peak luminosity across our grid of numerical models (Table~\ref{tab:jetParams}) as well as the luminosity originating exclusively from the slow component.  The slow component dominatens the peak flux for large $n_{18}$ and small frequencies, while the fast component dominates for high frequencies and low ambient gas densities.  Remarkably, the total peak luminosity is nearly independent of the ambient gas density; this is entirely coincidental, as the peak fluxes of the fast and slow components individually vary.  
%{\bf AG Not
...
The right hand panel of Fig.~\ref{fig:jetContours} compares the numerical results for the slow component with our analytic estimate in equation~\eqref{eq:peakLum}.  For large $n_{18}$, the numerical values of peak luminosity scale with density, jet energy, and frequency roughly as expected in the optically thick limit (``Case 2'').  For 30 GHz and low ambient gas densities, the numerical results asymptotically approach optically thin limit (``Case 1'').

The left-hand panel of Fig.~\ref{fig:ContoursTp} shows contours of the peak time, separately for the slow component and the total light curve.  Shown for comparison on the right hand side is the Case 2 peak
...
the peak time for the 30 GHz light curves decreases with density for small $n_{18}$, as the emitting region is optically thin at the deceleration time (``Case 1'').
