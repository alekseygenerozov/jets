...
The left-hand side of Fig.~\ref{fig:jetContours} shows contours of the peak luminosity for the slow component and total light curves across our grid of models (Table~\ref{tab:jetParams}). The radio flux from the slow component dominates for large $n_{18}$ and small
