...
Fig{fig:param} shows how $n_{18}$ varies with star burst
...
\, \Msun$) star. This gives $r_s\sim 1.6\times 10^{18}$ cm. Using
...
\begin{figure} 
  ...
  \caption{\label{fig:param} Isocontours for the density at $10^{18}$
    ...
    where massive stars ($\gsim 15 \, \Msun$) dominate the gas heating
