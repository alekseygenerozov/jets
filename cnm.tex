...
10^{54}$ erg, interacting with a low density CNM ($n_{18}=2$). 

For realistic break
radii $\gsim 1$ pc and our fiducial $E_{54}=4$, the break radius will
only be important for small densities ($n_{18}<20$). Henceforward we
will not consider the effects of the break radius in our analysis.
...
radius, $r_{Ia}$, where the time between successive Ias is equal to
