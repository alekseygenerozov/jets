...
\caption{\label{fig:components} Contributions from the fast
  ...
  (\textit{black}) for $n_{18}=2$ cm$^{-3}$ (\textit{top}) and $n_{18}=2000$ cm$^{-3}$
  (\textit{bottom}).}
\end{figure}


Equation~\ref{eq:peakLumGen} shows the dependence of the peak
luminosity slow component on jet parameters and ambient gas
...
equation~\eqref{eq:peakLum}, with $A_1=4.9\times 10^{40}$ and $A_2=1.1
\times 10^{42}$ to match the results for low and high nuclear gas
...
both with $n_{18}=2$ cm$^{-3}$.  The results are within a factor of a few of
each other. The core and cusp light curves are even closer at higher
densities, and virtually indistinguishable at $n_{18}=2000$ cm$^{-3}$. This is
...
profile, that noticeable differences emerge. {\bf AG why are there
  differences at early times for $n_{18}=2$ cm$^{-3}$ but not $n_{18}=2000$ cm$^{-3}$. Is
...
the fraction of the slow component ($\Gamma=2$) kinetic energy
