...
\begin{figure} 
  ...
  \caption{\label{fig:param} Contours of $n_{18}$, the CNM density
...
that of the slow sheath.  Following the best-fit model of SwJ1644 in \citet{Mimica+2015}, we adopt values for the microphysical parameters characterizing the fraction of the post-shock thermal energy placed into relativistic electrons ($\epsilon_e$) and magnetic field ($\epsilon_B$), and the power-law slope of the electron energy distribution $p$, as summarized in Table \ref{tab:jetParams}.
