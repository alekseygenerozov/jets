...
\begin{align}
n_{18} &\lsim 10^3 \Mbh[,7]^{0.5} \left(\frac{f_{\rm in}}{0.1}\right)
{\rm cm^{-3}}, 
\label{eq:tgrowDens}
\end{align}
...
We find that to a good approximation the late-time results of two
component 2-d simulations may be reproduced using a 1-d simulation
with the same fast core, and an expanded slow component extending to
$\theta=\pi/2$ radians. The isotropic equivalent jet energy for the
1-d simulations, should be fixed so that the true energy in the 1-d
and 2-d simulations would be the same.
