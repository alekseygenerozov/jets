...
parsecs of the galaxy {\bf AG: the x-ray luminosity decreases somewhat
  once cooling is included...Took the result for the cooling
  luminosity. I also divided by four to account for the faulty
  normalization cooling function.  However, with the proper
  normalization cooling would be less important so the x-ray
  luminosity may increase somewhat-->double check this.}


We also find and archival X-ray observation from ROSAT for this galaxy
{\bf AG describe observation here; look for other observation}. There
are no X-ray sources consistent with the galactic nucleus, which gives
a 90\% confidence of upper limit <2.4 counts over the $\sim$400 s
...
web-PIMMS tool\footnote{https://heasarc.gsfc.nasa.gov/cgi-bin/Tools/w3pimms/w3pimms.pl}. We
...
emission a solar metallicity ({\bf AG Check for metallicity
  measurements for this galaxy}), and $2.43\times 10^{20} cm^{-2}$ for
the galactic HI column density\footnote{taken from
...
model, though it shows the density cannot be much higher than we predict.
