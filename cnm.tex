...
\begin{figure*} 
  ...
  \caption{\label{fig:lightcurves} \textit{Left:} Radio light curves
    ...
    left, but comparing the total light curve ({\it opaque}) to just
    the contribution from the slow component of the jet ({\it
      lighter-shaded lines}).  {\bf BDM: I find these differences very
