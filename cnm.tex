...
% The deceleration time will correspond to the peak of the light curve,
% if the jet {\bf AG forward shock} is optically thin at this
% time. Otherwise, if the jet is optically thick, the peak will occur
% after the deceleration time, when the self-absorption frequency
% crosses the observer's band.
...
\nonumber\\
&\left(\frac{\nu_{\rm obs}}{5 {\rm GHz}}\right)^{1.8} {\rm ergs/s}
\label{eq:peakLum}
\end{align}
%
