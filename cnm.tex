...
observed value. In part, this is due to our neglect of discreteness
...
{\bf AG how much detail do I need to go into about Cuadra?} 

In order to precisely model the gas density distribution in a
particular galactic nucleus, detailed knowledge of the stellar
population and its distribution are necessary. However, here our goal
is to simply establish the range of plausible densities across the
space of possible galactic nuclei.
