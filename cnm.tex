...
\Msun$ we $r_{Ia}\simeq 10$ pc and a mass return efficiency
$\eta=0.4$. Plugging these into equation~\eqref{eq:nrs}, we obtain a
density of $\sim 1$ cm$^{-3}$. Taking $n\propto r^{-1}$, we then
obtain $n_{18}\sim 50$ cm$^{-3}$.
