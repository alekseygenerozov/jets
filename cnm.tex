...
except for very small values of $f$. The minimum density (eq.~\eqref
{eq:n18min}) is obtained for $f=4\times 10^{-4}$. However, for this
$f$, we expect less than 1 massive star within the stagnation
radius. In this case our formalism would break down, and the true
density would be larger.
...
\begin{figure} 
  \includegraphics[width=8cm]{fig_profs.pdf}
