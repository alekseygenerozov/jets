...
In this paper we address the range of gas densities encountered by jetted TDEs and the nature of their synchrotron emission by means of analytic calculations and numerical simulations.   We fix the jet properties to the best-fit model of \citet{Mimica+2015} for {\it Swift} J1644+57.  If we are led to the conclusion that the observable radio emission should be detected for all allowed CNM densities, then we are lead to the conclusion that most TDEs do not launch J1644-like jets.  This result would have significant implications for the physics of jet launching in TDEs and more broadly.  
