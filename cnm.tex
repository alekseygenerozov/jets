...
\item We take our two component jet model and run it through a range
  ...
  as months and as late as one decade after the TDE. By comparing
  radio detections and upper limits from a set optical/UV and soft
  X-ray selected TDE, we show that most of these sources cannot have
  jets as powerful as SwJ1644, at least for a CNM density profile of
  $n\propto r^{-1}$. If the density profile of most TDE hosts were
