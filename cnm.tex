...
its interaction with CNM spans a much larger interval i.e. the slow
component becomes almost isotropic \citep[bottom two panels in Fig. 8
in][]{Mimica+2015}. To account for this, we take $[0.1 {\rm rad},
\pi/2 {\rm rad}]$ for the angular extent of the slow component. Doing
so better reproduces the light curves from 2D jet simulation (see
...
in \citet{Mimica+2015}.
 ...
 % The hydrodynamic evolution of the components
% is independent of angle in 1D simulations, but the radiative
% transfer/light curve calculation is sensitive to the jet geometry.
