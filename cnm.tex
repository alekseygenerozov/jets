...
C of GSM15.\footnote{GSM15 included terms to account for mass and
  ...
  equations C1 and C2). These are always sub-dominant and we exclude
  them for simplicity.}  Given $\eta(t_{\rm burst},f_{\rm burst})$ and
...
= 40-300$ Myr.\footnote{GSM15 incorrectly extrapolated the Ia rate
  ...
  is unphysical as no white dwarfs would have formed by this time.
