...
curves for a $5\times 10^{53}$ erg jet and a few different densities:
n$_{18}$: 2, 60, and 2000 cm$^{-3}$ together with radio upper limits
and detections for various TDE candidates in
Fig.~\ref{fig:lightcurves} (these were compiled from various sources
into Table 1 of \citealt{Mimica+2015}). The energy is comparable to
that inferred for the Sw1644 jet.  All of the 5 GHz light-curves
