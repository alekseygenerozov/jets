...
overly sensitive to this choice for $n_{18}\geq 2$ cm$^{-3}$). We
expect that the peak luminosity will fall of roughly linearly with
$n_{18}$ at smaller densities. For example, for our derived density
lower limit of $0.5$ cm$^{-3}$, the above upper limit would increase
by a factor of 5.  Radio measurements of the peak flux following a TDE
...
is possible to place constraints on the energy of the jet/outflow from
higher frequency measurements. Fig.~\ref{fig:econtours} compares our
analytic fit to the on-axis 5 GHz synchrotron light curve
...
at late times. Thus, for times after peak each light in
...
consistent with it, with the caveat that these constraints would only
be valid if the density profile is $n\propto r^{-1}$ or shallower.
