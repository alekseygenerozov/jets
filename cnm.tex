...
clumps. However, as discussed in Section~\ref{sec:empirical}, from the
point of view a TDE jet a clumpy medium would not be too different
from a smooth one with the same average density.
