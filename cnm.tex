...
% greater than $\nu_m$. 
The peak of the light curve will occur at the deceleration time
(eq.~\ref{eq:tdec}) if the self-absorption frequency is below the
...
\end{align}
%
where $\Gamma$ is the Lorentz factor of the outflow. The additional
...
The unabsorbed flux at the peak frequency is
given by
...
\end{align}
%
Then from equations~\eqref{eq:tpeakGen}, ~\eqref{eq:Fnum},
and~\eqref{eq:Fpeak1}
