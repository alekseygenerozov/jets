...
\item The peak radio emission is most sensitive to the density at the
  ...
  inside the stagnation radius, $r_{\rm s}$.  In our numerical
  simulations we adopt a fiducial density profile of $n\propto
  r^{-1}$, as is expected near the Sedov/deceleration radius for
  powerful jets similar to SwJ1644.
...
\item We perform hydrodynamical simulations of our two component jet
  ...
  at radii $\ll r_{\rm s}$) alters the 2D dynamical evolution of the
  jet in a non-trivial way, resulting in a steeper post maximum
  decline of the radio light curve.
...
\item The time of the peak radio luminosity depends more sensitively
  ...
  upper limits from a set optical/UV and soft X-ray selected TDE, we
...
NASA Einstein Postdoctoral Felloswhip Program (grant SAO PF5-160145).
