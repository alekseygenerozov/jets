...
optically thick analytic predictions.  At 30 GHz, the peak time
decreases with $n_{18}$ at small values of the latter, because in this
regime the jet is optically thin prior to the deceleration time.
...
The peak radio luminosity at frequencies of a few GHz is weakly
...
that an upper limit of $F_{\rm ul}$ on the flux density of a source at
