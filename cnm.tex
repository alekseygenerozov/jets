...
limits. As shown in the right-hand panel of
Fig.~\ref{fig:lightcurves}, the light curves for a jet with 1\% of the
energy of Sw1644 are either comparable to or below existing upper
limits,
...
consistent less than S $\mu$Jy. Then from equation~\eqref{eq:peakLum},
we can constrain the energy of the jet to be

\begin{equation}
E\lsim 5 \times 10^{48} \left(\frac{S}{50 \,\mu{\rm Jy}}\right)
  \left(\frac{d}{200 \,{\rm Mpc}}\right)^{2} {\rm ergs}
\end{equation}
