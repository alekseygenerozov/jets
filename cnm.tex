...
heating the gas (\citealt{Quataert2004,Generozov+2015}).  In a
classical gamma-ray burst, the jet emerges into an environment which
is well-understood to be the wind of the massive stellar progenitor,
or the ISM of the host galaxy.  However, a priori the CNM density
encountered by a TDE jet could be orders of magnitude higher or lower.
