...
In the lab frame, The jet reaches this radius
at the deceleration time, given by
...
In general, we only include only emission from the forward shock, as
the emission from the reverse shock would be self-absorbed or absorbed
by the forward shock over most of the parameter space.

The fraction of jet kinetic energy dissipated by the reverse shock
provides an upper bound on its contribution to the overall light
curve. Fig.~\ref{fig:diss} shows the fraction of the slow component
($\Gamma_{\rm j}=2$) kinetic energy dissipated by the reverse shock as
a function of isotropic jet luminosity and $n_{18}$. For the purposes
of our analytic estimates, we assume a constant luminosity jet, which
shuts off after time $5 \times 10^{5}$ s.
