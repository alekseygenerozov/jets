...
the radius of the sphere of influence, $r_{\rm inf}$, the enclosed stellar and black masses are equal, $M_{\star}(r_{\rm inf})=\Mbh$.  We following GSM15 in taking $r_{\rm inf}=3.5 \Mbh[,7]^{0.6}$, where $\Mbh[,7]=\Mbh/10^7
\Msun$.
...
swept up it's own mass in nuclear gas. For SwJ1644 the deceleration
