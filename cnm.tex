...
densities resulting from mass loss by stellar winds. Then we convert
...
profiles. Additionally, as described in \citet{Stone&Metzger2016} 
...
Fig.~\ref{fig:ContoursTp} shows contours for the time of the peak time
. All other things being equal, a higher energy jet will produce a
radio light curve peaking later in time. Also, over most of the
parameter space, a higher ambient gas density results in a later peak
time. This is an absorption effect: the peak usually occurs when the
jet transitions from being optically thick to thin in the observing
band {\bf AG: is this true when fast component dominates at the peak
  of the light curve?} This occurs later for an ambient medium with a
larger density. However, for high frequencies and low densities...
