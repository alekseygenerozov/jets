...
stars. To estimate the star formation rate, we conjecture that the CNM
self-regulates itself to a condition of marginal thermal
stability (so that the cooling time, $t_{\rm cool}$, is ten times the
dynamical time). For the case of a TDE host with a 1 Gyr old stellar
...
\begin{figure} 
  ...
  \caption{\label{fig:param} Isocontours for the density at $10^{18}$
    ...
    by our formalism become important.}
\end{figure}
...
for which the Sedov radius lies outside of the flattening the core
density profile, that noticeable difference emerge. {\bf AG why are
